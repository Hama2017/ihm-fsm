      ...
      <div class="flex items-center gap-4">
        ...
        <div class="relative">
          ...
          >
            ...
            <span 
              class="absolute top-0 right-0 h-4 w-4 rounded-full text-xs flex items-center justify-center bg-red-500 text-white"
            >
              3
            </span>
          </button>
          ...
          >
            <div class="py-2 px-4 border-b transition-colors duration-300"
