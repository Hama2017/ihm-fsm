      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
        ...
        <div class="space-y-4">
          ...
          <div class="pt-2 mt-4 border-t border-gray-200 dark:border-gray-700">
            <h3 class="text-base font-medium text-gray-900 dark:text-white mb-2">Écran de démarrage</h3>
            <button 
              @click="resetSplashScreen" 
              class="px-4 py-2 bg-blue-100 hover:bg-blue-200 dark:bg-blue-900 dark:hover:bg-blue-800 text-blue-800 dark:text-blue-200 rounded-lg transition-colors duration-200"
            >
              Réafficher l'écran de démarrage
            </button>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
              L'écran de démarrage s'affichera à nouveau lors de la prochaine visite.
            </p>
          </div>
        </div>
      </div>
...
// Réinitialiser l'état du splash screen pour qu'il s'affiche à nouveau
const resetSplashScreen = () => {
  localStorage.removeItem('splash_screen_seen');
  alert('L\'écran de démarrage s\'affichera à nouveau lors de votre prochaine visite.');
};
