...
def login_user(credentials: UserLogin, response: Response) -> UserOut:
    """
    ...
    refresh_token_expiry = datetime.utcnow() + timedelta(days=auth_settings.REFRESH_TOKEN_EXPIRE_DAYS)
...
def refresh_tokens(
    ...
    new_expiry = datetime.utcnow() + timedelta(days=auth_settings.REFRESH_TOKEN_EXPIRE_DAYS)
