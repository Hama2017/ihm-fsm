  ...
  <div>
    <div v-for="(variable, index) in modelValue" :key="index" class="mb-6 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
      <div class="flex justify-between items-center mb-3">
        <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('packages.variable.name') }} #{{ index + 1 }}</h3>
      ...
      <div class="mb-4">
        ...
        <input
          ...
          required
          :placeholder="t('packages.variable.name')"
