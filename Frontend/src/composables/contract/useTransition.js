...
export default function useTransition({
  ...
  const confirmEditTransition = () => {
    try {
      ...
      //   : Régénérer le nom de la transition
  ...
  const confirmInvertTransition = () => {
    ...
    try {
      ...
      //  Générer le  nom pour la transition inversée
      ...
      console.log(' Transition inversée avec succès.  nom:', newLabel);
  ...
  return {
    //  : États et fonctions du modal de connexion
    showConnectionModal,
    connectionModalData,
